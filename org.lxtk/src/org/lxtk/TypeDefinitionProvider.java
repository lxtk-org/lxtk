...
/**
 * Provides type definition locations for the symbol denoted by a given text document position.
 *
 * @see LanguageService
 */
public interface TypeDefinitionProvider
    extends LanguageFeatureProvider<TypeDefinitionRegistrationOptions>
{
    /**
