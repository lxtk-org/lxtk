    ...
    extends TextDocumentLanguageFeature<SignatureHelpRegistrationOptions>
{
    ...
    void initialize(ServerCapabilities capabilities, List<DocumentFilter> documentSelector)
    {
        ...
        SignatureHelpRegistrationOptions registerOptions = new SignatureHelpRegistrationOptions(
            capability.getTriggerCharacters(), capability.getRetriggerCharacters());
        registerOptions.setDocumentSelector(documentSelector);
        registerOptions.setWorkDoneProgress(capability.getWorkDoneProgress());
