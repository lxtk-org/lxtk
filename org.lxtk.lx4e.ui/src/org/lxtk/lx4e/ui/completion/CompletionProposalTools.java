...
final class CompletionProposalTools {
     ...
     */
    static String getFilterFromDocument(IDocument document, int cursorOffset, String completionItemFilter,
     ...
     * @param string
     */
    static boolean isSubstringFoundOrderedInString(String subString, String string) {
        int lastIndex = 0;
     ...
     */
    static int getCategoryOfFilterMatch(String documentFilter, String completionFilter) {
     ...
     */
    static int getScoreOfFilterMatch(String documentFilter, String completionFilter) {
        documentFilter = documentFilter.toLowerCase();
        completionFilter = completionFilter.toLowerCase();
