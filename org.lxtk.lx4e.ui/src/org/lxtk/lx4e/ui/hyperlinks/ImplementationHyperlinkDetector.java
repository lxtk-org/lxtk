...
import org.lxtk.lx4e.ImplementationRequest;
    ...
    extends AbstractLocationHyperlinkDetector
{
    ...
    {
        String text = Messages.ImplementationHyperlinkDetector_Hyperlink_text;
        if (++index > 0)
        ...
        List<? extends Location> locations)
    {
        ...
        return new ShowSearchResultHyperlink(region,
            Messages.ImplementationHyperlinkDetector_Hyperlink_text2, new LocationSearchQuery(
