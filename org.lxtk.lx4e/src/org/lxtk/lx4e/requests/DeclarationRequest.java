...
public class DeclarationRequest
    extends LanguageFeatureRequestWithWorkDoneAndPartialResultProgress<DeclarationProvider,
        DeclarationParams, Either<List<? extends Location>, List<? extends LocationLink>>>
{
    @Override
