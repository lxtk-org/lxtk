...
public class ImplementationRequest
    extends LanguageFeatureRequestWithWorkDoneAndPartialResultProgress<ImplementationProvider,
        ImplementationParams, Either<List<? extends Location>, List<? extends LocationLink>>>
{
    @Override
