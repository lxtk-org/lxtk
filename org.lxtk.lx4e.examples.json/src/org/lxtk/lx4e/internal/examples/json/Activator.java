...
{
    // The plug-in ID
    public static final String PLUGIN_ID = "org.lxtk.lx4e.examples.json"; //$NON-NLS-1$

    // The shared instance
    private static Activator plugin;

    private Runnable stopRunnable;
    private JsonLanguageClient languageClient;
    private JsonSourceFileDocumentProvider documentProvider;

    public JsonSourceFileDocumentProvider getDocumentProvider()
    {
    ...
    public void start(BundleContext context) throws Exception
    {
        ...
        {
            languageClient = new JsonLanguageClient();
            ...
            documentProvider = new JsonSourceFileDocumentProvider();
